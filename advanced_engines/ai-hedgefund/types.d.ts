...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'Loose-ai-analysis': EventHandler<{ query?: string; timestamp: string; response?: unknown; error?: string }, { topic: 'parallel.analyses.started'; data: { query?: string; timestamp: string; response?: unknown; analysisInput?: unknown; generalAnalysis?: unknown; traceId?: string } }>
