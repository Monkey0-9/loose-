"""
Candilyzer: AI-powered candidate analyzer for advanced technical hiring.
...
Agents are powered by Loose and enhanced with agno’s GitHubTools, ExaTools, ThinkingTools,
...
st.markdown("""
    <div style="text-align:center;">
        ...
        <p style="font-size:1.1rem;">Advanced GitHub + LinkedIn Candidate Analyzer for Tech Hiring</p>
    </div>
""", unsafe_allow_html=True)

# Session state init
for key in ["Loose_api_key",  "model_id", "github_api_key", "exa_api_key"]:
...
st.session_state.Loose_api_key = st.sidebar.text_input("Loose API Key", value=st.session_state.Loose_api_key, type="password")
...
if page == "Multi-Candidate Analyzer":
    ...
    if submit:
        ...
        elif not all([st.session_state.Loose_api_key, st.session_state.github_api_key, st.session_state.exa_api_key, st.session_state.model_id]):
            ...
            if not usernames:
                ...
                agent = Agent(
                    ...
                    model=Loose(
                        ...
                        api_key=st.session_state.Loose_api_key,
                    ),
