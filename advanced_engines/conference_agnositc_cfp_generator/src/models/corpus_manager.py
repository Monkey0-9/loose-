...
class ConferenceCorpusManager:
        ...
        try:
            ...
            for batch_start in range(0, len(talks), batch_size):
                ...
                for i, talk in enumerate(batch):
                    ...
                    try:
                        ...
                        embedding = self.Loose_client.generate_embedding(combined_text)
            ...
            metadata_doc = {
                **conference_info,
                ...
                'embedding_model': self.Loose_client.embedding_model,
                'collection_name': collection_name
            }
    ...
    def get_similar_talks(
        ...
        try:
            ...
            query_embedding = self.Loose_client.generate_embedding(query)
