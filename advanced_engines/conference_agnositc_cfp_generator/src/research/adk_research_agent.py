...
# Use our clean Loose client instead of Loose Agent Toolkit
from ..config.Loose_client import LooseClient


class ResearchOrchestrator:
    """Custom research orchestrator using Loose AI Engine directly"""
    
    def __init__(self):
        self.client = LooseClient()
    ...
    def analyze_with_Loose(self, topic: str, search_results: Dict[str, Any]) -> str:
        """Use Loose AI Engine to analyze and synthesize the search results"""
...
def run_adk_research(topic: str) -> str:
    ...
    Uses OpenRouter with Grok-4 directly without Loose Agent Toolkit dependencies.
    """
    ...
    try:
        ...
        # Step 2: Analyze results with Loose AI Engine
        print("🧠 Analyzing results with Loose AI Engine...")
        final_analysis = orchestrator.analyze_with_Loose(topic, search_results)
