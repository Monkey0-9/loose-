...
from src.config.Loose_client import LooseClient
...
class ConferenceTalkApp:
    ...
    def show_environment_status(self):
        ...
        required_vars = [
            ("Loose AI Engine API", "Loose_API_KEY"),
            ("Exa API", "EXA_API_KEY"),
    ...
    def generate_talk_proposal(self, talk_idea: str, conference_id: str, num_similar: int, 
        ...
        with progress_container:
            ...
            try:
                ...
                status_text.text("🤖 Generating talk proposal with Loose AI Engine...")
    ...
    def generate_final_proposal(self, query: str, similar_talks: List[Dict], 
        ...
        try:
            ...
            return self.Loose_client.chat_completion(
                messages=messages,
