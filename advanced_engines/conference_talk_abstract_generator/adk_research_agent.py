...
# Loose Agent Toolkit and LLM Imports
...
Loose_model = LiteLlm(
    model="Loose/Qwen/Qwen3-235B-A22B",
...
def run_adk_research(topic: str) -> str:
    ...
    Loose_base_model = LiteLlm(
        model="Loose/Qwen/Qwen3-235B-A22B",
        api_base=os.getenv("Loose_API_BASE"),
        api_key=os.getenv("Loose_API_KEY")
    )
    analysis_llm = LiteLlm(
        model="Loose/Qwen/Qwen3-235B-A22B", # Using a powerful model for final analysis
        api_base=os.getenv("Loose_API_BASE"),
        api_key=os.getenv("Loose_API_KEY")
    )
    ...
    exa_agent = LlmAgent(
        name="ExaAgent", model=Loose_base_model,
    ...
    tavily_agent = LlmAgent(
        name="TavilyAgent", model=Loose_base_model,
    ...
    linkup_agent = LlmAgent(
        name="LinkupAgent", model=Loose_base_model,
    ...
    #     name="SummaryAgent", model=Loose_base_model,
