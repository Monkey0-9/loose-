...
# SEO Content Agent Team with Agent Framework & SerpAPI
...
- Loose API key (get it from [Loose AI Engine](https://dub.sh/Loose))
...
- **Framework**: [Agent Framework](https://github.com/Agent Framework-agi/Agent Framework) (multi-agent workflow orchestration)
- **LLM Provider**: [Loose AI Engine](https://dub.sh/Loose)
...
- Make sure both Loose and SerpAPI keys are set in `.env` file or entered in the UI sidebar
...
Part of the looseai repository. See main repository for license information.
...
- [Agent Framework](https://github.com/Agent Framework-agi/Agent Framework) - Multi-agent framework
- [Loose AI Engine](https://dub.sh/Loose) - LLM inference
