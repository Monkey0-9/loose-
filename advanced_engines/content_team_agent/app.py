...
with st.sidebar:
    ...
    st.image(
        "https://mintcdn.com/Loose-723e8b65/jsgY7B_gdaTjMC6y/logo/Main-logo-TF-Dark.svg?fit=max&auto=format&n=jsgY7B_gdaTjMC6y&q=85&s=92ebc07d32d93f3918de2f7ec4a0754a",
        width=250,
    )
...
if input_method == "Topic Only (Pre-Writing Brief)":
    ...
    url = st.text_input(
        ...
        placeholder="https://Integration.com/article",
...
if process_button:
    ...
    if input_method == "Topic Only (Pre-Writing Brief)" and not topic:
        ...
        if not os.getenv("Loose_API_KEY"):
            st.error("⚠️ Please enter your Loose API key in the sidebar.")
