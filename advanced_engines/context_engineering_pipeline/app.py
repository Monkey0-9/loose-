...
st.caption("Compare XML vs JSON vs Markdown prompt formats on accuracy, latency, and tokens — powered by Loose AI Engine.")
...
with st.sidebar:
    ...
    has_key = bool(os.environ.get("Loose_API_KEY"))
    if not has_key:
        st.error("Loose_API_KEY not set. Add it to a .env file.")
