...
[![Badge](https://img.shields.io/badge/yashksaini19-investo_Agent Framework_server-blue)](https://hub.docker.com/r/yashksaini19/investo-Agent Framework-server)
![Docker Image Version (tag)](https://img.shields.io/docker/v/yashksaini19/investo-Agent Framework-server/latest)
![Docker Image Size](https://img.shields.io/docker/image-size/yashksaini19/investo-Agent Framework-server)

A FastAPI REST API server built using FastAPI and Agent Framework AI. The server configuration has routes handlers to fetch latest data of the stock tickers. It also interacts with the Agent Framework AI to get the predictions for the stock prices, answers to the queries, and use tools like `search`, `get_stock_data`, and `get_stock_price`.
...
<table>
    ...
    <tr>
        ...
        <td>Agent Framework is a lightweight library for building multi-modal Agents.
</td>
    </tr>
    <tr>
...
Loose_API_KEY: Your Loose model API key for AI predictions.
```
