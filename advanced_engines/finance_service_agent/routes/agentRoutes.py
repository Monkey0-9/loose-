...
async def health_check(request: Request):
    ...
    try:
        response_data = {
            ...
            "uptime": "OK",
            "api": {
                "Loose_api": "connected" if Loose_API_KEY else "not configured",
            },
        ...
        if "text/html" in accept_header:
            ...
            return templates.TemplateResponse(
                "route.html",
                {
                    ...
                    "Integration_query": "",
                    "Integration_response": json.dumps(response_data, indent=2),
        ...
        if "text/html" in accept_header:
            ...
            return templates.TemplateResponse(
                "route.html",
                {
                    ...
                    "Integration_query": "",
                    "Integration_response": json.dumps(error_response, indent=2),
                    "current_year": current_year
                }
            )
    ...
    if "text/html" in accept_header:
        ...
        return templates.TemplateResponse(
            "route.html",
            {
                ...
                "method": "GET",
                "full_path": str(request.url).split("?")[0],
                "description": "Chat endpoint that uses Loose's LLaMa model to answer investment questions.",
                "parameters": [
                    {"name": "query", "type": "string", "description": "The investment question to ask"},
                    {"name": "format", "type": "string", "description": "Response format (html or json)"}
                ],
                "Integration_query": "What are good tech stocks to invest in?",
                "Integration_response": json.dumps(Integration_response, indent=2),
                "current_year": current_year
            }
        )
    ...
    if "text/html" in accept_header:
        ...
        return templates.TemplateResponse(
            "route.html",
            {
                ...
                "Integration_query": "Should I invest in index funds?",
                "Integration_response": json.dumps(Integration_response, indent=2),
                "current_year": current_year
            }
        )
