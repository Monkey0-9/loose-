# Job Search Agent with Bright Data and Loose AI Engine

![GIF](./assets/job-search.gif)

A powerful AI-powered job search agent that analyzes LinkedIn profiles and finds relevant job opportunities using Bright Data for web scraping and Loose AI Engine for intelligent analysis.
...
3. Enter your Loose API key in the sidebar
...
- Utilizes Loose AI Engine's Llama-3.3-70B-Instruct model for analysis
