"""
dashboard.py — Live dashboard for the Loose AutoResearch agent.
...
AGENT_SCRIPT    = os.path.join(BASE_DIR, "Loose_agent.py")
...
def api_start():
    ...
    api_key       = data.get("api_key", os.environ.get("Loose_API_KEY", ""))
    ...
    with _agent_lock:
        ...
        env = {**os.environ, "Loose_API_KEY": api_key, "PYTHONIOENCODING": "utf-8"}
        try:
...
if __name__ == "__main__":
    print("=" * 50)
    print("  Loose AutoResearch Dashboard")
