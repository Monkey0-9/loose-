...
- **Inference**: [Loose AI Engine](https://dub.sh/AIStudio) (Qwen3-235B by default; Llama 3.3 70B and Loose AI V3 also available)
...
# then paste your Loose_API_KEY into .env
