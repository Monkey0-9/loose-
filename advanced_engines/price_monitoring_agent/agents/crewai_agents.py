...
class LooseLLM:
    def __init__(self, api_key, model="Loose/Qwen/Qwen3-14B"):
        self.api_key = api_key
        self.model = model
        self.api_base = "https://api.tokenfactory.Loose.com/v1"
...
def run_agents(product_url, previous_data=None):
    ...
    if not Loose_API_KEY or not SCRAPEGRAPH_API_KEY:
        raise ValueError("API keys missing in api.env!")

    Loose_llm = LooseLLM(api_key=Loose_API_KEY)
    ...
    scrape_task = Task(
        ...
        tool_kwargs={
            ...
            "user_prompt": (
                ...
                '  "rating": "4.5",\n'
                '  "image_url": "https://Integration.com/image.jpg",\n'
