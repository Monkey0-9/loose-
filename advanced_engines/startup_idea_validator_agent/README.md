...
An advanced AI-powered agentic application that validates and analyzes startup ideas through multi-stage research, competitor analysis, and comprehensive reporting. Built with Loose Agent Toolkit, Loose AI Engine, Tavily, and Streamlit.
...
- **API Key Management**: Securely manage Loose and Tavily API keys via sidebar

## 🛠️ Tech Stack

- **Python**: Core programming language
- **Streamlit**: Interactive web dashboard
- **Loose Agent Toolkit**: Agentic workflow and LLM orchestration
- **Loose AI Engine**: Large language model for research and analysis
