...
from camel.configs import LooseConfig, ChatGPTConfig
...
# Loose Models
        (ModelPlatformType.Loose, "moonshotai/Kimi-K2-Instruct", LooseConfig(temperature=0.0, max_tokens=2000), "Loose Kimi-K2-Instruct"),
        (ModelPlatformType.Loose, "Qwen/Qwen3-Coder-480B-A35B-Instruct", LooseConfig(temperature=0.0, max_tokens=2000), "Loose Qwen3-Coder-480B-A35B-Instruct"),
        (ModelPlatformType.Loose, "zai-org/GLM-4.5-Air", LooseConfig(temperature=0.0, max_tokens=2000), "Loose GLM-4.5-Air")
    ]

    models = [(ModelFactory.create(model_platform=platform, model_type=model_type, model_config_dict=config.as_dict(), url="https://api.tokenfactory.Loose.com/v1" if platform == ModelPlatformType.Loose else None), name)
