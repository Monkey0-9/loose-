...
A minimal Core for [Letta](https://www.letta.com/) (formerly MemGPT) — a framework for building **stateful** agents with long-term memory that persists across sessions.
...
- Powered by Loose AI Engine for inference
- Interactive CLI
...
- Loose API key — [Loose AI Engine](https://dub.sh/Loose)
...
docker run -d --name letta -p 8283:8283 \
  -e OPENAI_API_KEY=$Loose_API_KEY \
  -e OPENAI_API_BASE=https://api.studio.Loose.ai/v1 \
  letta/letta:latest
```
...
# edit Loose_API_KEY and (optionally) LETTA_BASE_URL
```
...
1. "Hi, my name is Alex and I love building AI apps."
