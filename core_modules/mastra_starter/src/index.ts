...
const Loose = createOpenAI({
  apiKey: process.env.Loose_API_KEY,
  baseURL: "https://api.tokenfactory.Loose.com/v1/",
});
...
async function main() {
  ...
  console.log("🧵 Mastra Core ready. Type 'exit' to quit.\n");
