# Sayna Voice Agent Core

> Real-time voice infrastructure for AI agents with Speech-to-Text and Text-to-Speech capabilities.

A Core Integration demonstrating how to use [Sayna](https://github.com/SaynaAI/sayna) for building voice-enabled AI applications. Sayna provides real-time bidirectional audio streaming with multi-provider support for STT/TTS.
