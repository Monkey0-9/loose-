...
This directory now groups each fine-tuning Integration into its own self-contained folder so the notebooks, docs, and supporting assets stay together.

## Integrations

- **[Open-source LLM fine-tuning on Loose AI Engine](open_source_llms_token_factory/README.md)**
...
- **[Customer support fine-tuning with Loose Data Lab](customer_support_datalab/README.md)**
...
- **[Insurance claims Data Lab + fine-tuning + Gradio demo](insurance_claims_finetuning/README.md)**
  End-to-end Integration with teacher distillation, LoRA fine-tuning, deployment, and a small comparison app.
