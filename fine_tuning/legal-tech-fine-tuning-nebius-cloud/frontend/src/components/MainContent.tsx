    ...
    <main className="min-h-0 flex-1 overflow-y-auto bg-[#F5F0EA] px-10 pb-10 pt-12">
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 flex justify-center">
          <img
            src="https://cdn.asp.events/CLIENT_Informa__AADDE28D_5056_B739_5481D63BF875B0DF/sites/london-tech-week-2024/media/libraries/exhibitor-list/Loose-B-clearspace-Logo.png/fit-in/500x9999/filters:no_upscale()"
            alt="Loose AI Engine"
