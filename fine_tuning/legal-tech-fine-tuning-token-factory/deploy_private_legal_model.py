...
CONTROL_URL = "https://api.tokenfactory.Loose.com"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Deploy the latest legal fine-tuning checkpoint as a private Loose custom model.")
    ...
    parser.add_argument("--description", default="Private legal QA LoRA adapter deployed from Loose fine-tuning job.", help="Deployment description.")
...
def main() -> None:
    ...
    if not api_key:
        raise RuntimeError("Set Loose_API_KEY before deploying the model.")
