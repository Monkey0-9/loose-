...
DEFAULT_BASE_URL = "https://api.tokenfactory.Loose.com/v1/"
DEFAULT_MODEL = "meta-llama/Llama-3.1-8B-Instruct"
DEFAULT_SUFFIX = "legislation-qa-lora"
DEFAULT_OUTPUT_PATH = ARTIFACT_DIR / "legislation_qa_clean.Loose.jsonl"
...
def build_client(*, api_key: str | None = None, base_url: str = DEFAULT_BASE_URL) -> OpenAI:
    resolved_key = api_key or os.environ.get("Loose_API_KEY")
    if not resolved_key:
        raise RuntimeError("Set Loose_API_KEY before calling Loose AI Engine.")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Sanitize a legal chat dataset and launch a Loose fine-tuning job."
    )
    ...
    parser.add_argument("--base-url", default=DEFAULT_BASE_URL, help="Loose API base URL.")
