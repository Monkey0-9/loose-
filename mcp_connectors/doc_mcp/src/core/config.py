...
class Settings(BaseSettings):
    ...
    # Loose
    Loose_api_key: str = Field(..., env="Loose_API_KEY")
    Loose_llm_model: Optional[str] = Field(default="meta-llama/Llama-3.3-70B-Instruct-fast", env="Loose_LLM_MODEL")
    Loose_embedding_model: Optional[str] = Field(default="BAAI/bge-en-icl", env="Loose_EMBEDDING_MODEL")
