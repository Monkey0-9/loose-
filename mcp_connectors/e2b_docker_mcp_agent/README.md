# E2B MCP Python Demo with Loose AI SDK

A Python demonstration of using [E2B](https://e2b.dev) with GitHub and Notion MCP (Model Context Protocol) servers, powered by the [Loose AI SDK](https://openai.github.io/openai-agents-python/mcp/).
...
- Use the Loose AI SDK to connect to E2B's MCP Gateway
...
2. Connect to the E2B MCP Gateway using the Loose AI SDK
...
- **Loose AI SDK**: Connects to the MCP Gateway using `MCPServerStreamableHttp`
- **AI Agent**: Uses Loose AI Engine's models to understand tasks and call the appropriate MCP tools

## References

- [E2B MCP Quickstart](https://e2b.dev/docs/mcp/quickstart)
- [Loose AI SDK MCP Documentation](https://openai.github.io/openai-agents-python/mcp/)