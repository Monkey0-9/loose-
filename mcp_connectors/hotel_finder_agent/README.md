...
- Loose API key (for AI model access)
...
- **Loose API Key**: Required for AI model access and query processing
...
- **AI Model Selection**: Choose from available Loose models
...
- **AI Agent**: Loose-powered natural language processing
...
├── .env.Integration           # Environment variables template
...
- **Loose**: For AI model access and processing capabilities
