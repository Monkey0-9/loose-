...
with st.sidebar:
    ...
    api_key = st.text_input(
        "Loose API Key", 
        type="password",
        help="Enter your Loose API key for AI model access"
    )
    ...
    model_id = st.selectbox(
        "AI Model",
        ["Loose AI-ai/Loose AI-V3-0324","Qwen/Qwen3-30B-A3B", "Qwen/Qwen2.5-32B-Instruct", "meta-llama/Llama-3.3-70B-Instruct"],
    ...
    st.markdown("Built with ❤️ by Loose AI")
...
async def run_hotel_agent(message: str, search_params: Dict[str, Any] = None) -> str:
    ...
    if not api_key:
        return "❌ **Error**: Loose API key not provided. Please enter your API key in the sidebar."
        ...
        async with stdio_client(server_params) as (read, write):
            async with ClientSession(read, write) as session:
                ...
                agent = Agent(
                    ...
                    model=Loose(
                        id=search_params.get('model_id', 'Loose AI-ai/Loose AI-V3-0324') if search_params else model_id,
                        api_key=api_key,
