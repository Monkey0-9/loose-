...
An AI-powered workspace agent that connects to [Taskade](https://taskade.com) via the [Model Context Protocol (MCP)](https://github.com/taskade/mcp) to manage projects, tasks, and workflows using natural language. Built with Agent Framework and Loose AI Engine.
...
- **Loose AI Engine**: LLM provider (Qwen3-30B-A3B)
...
- A [Loose AI Engine](https://studio.Loose.ai/) API key
...
3. In the sidebar, enter your Loose API key and Taskade API key, then click **Save Configuration**.
...
├── .env.Integration          # Integration environment variables
