...
with st.sidebar:
    ...
    Loose_key = st.text_input("Loose API Key", type="password")
    if Loose_key:
...
async def run_taskade_agent(message: str) -> str:
    ...
    if not Loose_api_key:
        return "Error: Loose API key not provided. Please enter it in the sidebar."
...
if st.button("Run Query", type="primary", use_container_width=True):
    ...
    elif not os.getenv("Loose_API_KEY"):
