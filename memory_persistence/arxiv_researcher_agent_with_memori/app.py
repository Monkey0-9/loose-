...
def main():
    ...
    with st.sidebar:
        ...
        Loose_key = st.text_input("Enter your Loose API key", value=os.getenv("Loose_API_KEY", ""), type="password")
        ...
        if tab_choice == "🔬 Research Chat":
            ...
            st.markdown("### 🔬 Integration Research Topics:")
        ...
        # st.rerun()
            ...
            st.markdown("### 🧠 Integration Memory Queries:")
