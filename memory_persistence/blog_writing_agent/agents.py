...
def analyze_writing_style(text: str) -> Dict[str, Any]:
    ...
    try:
        ...
        5. Use of Integrations, analogies, or storytelling
        ...
        - Integrations_style: string describing how Integrations/analogies are used
        ...
        try:
            ...
            return {
                ...
                "Integrations_style": "Uses relevant Integrations",
