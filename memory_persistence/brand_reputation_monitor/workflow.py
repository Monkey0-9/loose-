...
# Initialize Loose AI Engine model
Loose_model = Loose(
...
def get_best_news_urls(news_pages, num_news):
    # Use Loose AI Engine to extract the most relevant news URLs
    agent = Agent(
...
- [insight 5]""",
    ...
    # Analyze each news article with Loose AI Engine for brand reputation monitoring insights
