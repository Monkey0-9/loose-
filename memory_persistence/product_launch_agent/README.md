...
- Python 3.10+
- Loose AI Engine API key ([Get it here](https://studio.Loose.ai/))
...
cd memory_persistence/product_launch_agent
```
...
> **Note:** This application uses **Loose AI Engine** for powering the AI agents. Get your API key from [Loose AI Engine](https://studio.Loose.ai/).
