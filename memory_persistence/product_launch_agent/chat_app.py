...
with st.sidebar:
    ...
    Loose_api_key_input = st.text_input(
        ...
        type="password",
        help="Your Loose API key for AI models",
    )
...
if "agent_team" not in st.session_state and Loose_key and brightdata_key:
    try:
...
Integration: "I want a Product Launch Analysis for Monday.com"
"""
            ...
            with st.spinner("🤔 Thinking..."):
                try:
                    ...
                    if is_new_analysis:
                        ...
                        # Use Loose for follow-up questions with context from Memori
