...
- Python 3.10+
- Loose AI Engine API credentials
...
3. Configure your API keys in the sidebar (Loose and ScrapeGraph)
...
- **Style Analysis**: Loose AI Engine analyzes tweeting patterns, tone, and personality
...
- **Style Analyzer**: Analyzes tweeting patterns using Loose AI Engine
