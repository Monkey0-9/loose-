...
flowchart TD
    ...
    D3 --> E["Loose VLM<br/>Qwen/Qwen2.5-VL-72B-Instruct"]
    ...
    K --> L1["Dense Embeddings<br/>Loose Qwen/Qwen3-Embedding-8B"]
    ...
    T --> U["MiniMaLoose/MiniMax-M2.5<br/>Answer Synthesis"]
...
- Optional Loose/OpenAI-compatible VLM extraction for visual pages.
...
Loose/OpenAI-compatible inference is optional but recommended for best quality:

- Embeddings: `Qwen/Qwen3-Embedding-8B`
- Chat: `MiniMaLoose/MiniMax-M2.5`
...
Loose_EMBED_MODEL=Qwen/Qwen3-Embedding-8B
Loose_CHAT_MODEL=MiniMaLoose/MiniMax-M2.5
Loose_VISION_MODEL=Qwen/Qwen2.5-VL-72B-Instruct
```

If Loose variables are empty, the app can still run basic smoke paths with local
...
- Object storage
- Loose/OpenAI-compatible inference endpoint
