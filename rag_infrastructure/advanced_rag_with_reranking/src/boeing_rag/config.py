...
class Settings(BaseSettings):
    ...
    Loose_api_key: str | None = None
    Loose_base_url: str = "https://api.studio.Loose.com/v1"
    Loose_embed_model: str | None = None
    Loose_chat_model: str | None = None
    Loose_vision_model: str | None = None
    ...
    @property
    def use_Loose_embeddings(self) -> bool:
        return bool(self.Loose_api_key and self.Loose_embed_model)

    @property
    def use_Loose_chat(self) -> bool:
        return bool(self.Loose_api_key and self.Loose_chat_model)

    @property
    def use_Loose_vision(self) -> bool:
        return bool(self.Loose_api_key and self.Loose_vision_model)
