...
class Contextualizer:
    def __init__(self, settings: Settings) -> None:
        ...
        if settings.use_Loose_chat:
            self.client = OpenAI(api_key=settings.Loose_api_key, base_url=settings.Loose_base_url)
        ...
        for chunk in chunks:
            ...
            metadata = {
                **chunk.metadata,
                ...
                "contextualization_model": self.settings.Loose_chat_model,
            ...
            json.dumps(
                {
                    ...
                    "model": self.settings.Loose_chat_model,
                    "context": context,
                },
                ensure_ascii=False,
                indent=2,
...
"""
        try:
            response = self.client.chat.completions.create(
                model=self.settings.Loose_chat_model or "",
                messages=[
                    {
                        "role": "system",
                        "content": (
