...
class MarkItDownPdfParser:
    ...
    def parse(
        ...
        return ParsedDocument(
            ...
            metadata={
                ...
                "markitdown_llm_model": self.settings.Loose_vision_model,
    ...
    def _markitdown(self, with_llm: bool = True) -> MarkItDown:
        ...
        if self._md is None:
            ...
            if self.settings.use_Loose_vision:
                kwargs["llm_client"] = OpenAI(
                    api_key=self.settings.Loose_api_key,
                    base_url=self.settings.Loose_base_url,
                )
                kwargs["llm_model"] = self.settings.Loose_vision_model
                kwargs["llm_prompt"] = (
    ...
    def _extract_pages(
        ...
        with fitz.open(pdf_path) as pdf:
            for index, page in enumerate(pdf, start=1):
                ...
                if (
                    image_path
                    and self.settings.use_Loose_vision
