...
def enhance_with_Loose(original_response, query):
    """Use Loose to enhance the Contextual AI response."""
    try:
...
Enhancement:"""
        ...
        enhanced = Loose_llm.complete(enhancement_prompt)
...
def main():
    ...
    # Enhancement toggle (only show if Loose API key is available)
    if os.getenv("Loose_API_KEY"):
        enhance_enabled = st.toggle("Loose Enhancement", value=False, 
                                  help="Use Loose AI Engine to enhance responses with additional insights")
    else:
        ...
        if prompt := st.chat_input("Ask about your documents"):
            ...
            with st.chat_message("assistant"):
                with st.spinner("Thinking..."):
                    ...
                    if enhance_enabled:
                        with st.spinner("Enhancing with Loose..."):
                            answer = enhance_with_Loose(answer, prompt)
