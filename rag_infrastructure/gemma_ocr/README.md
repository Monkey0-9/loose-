...
# Gemma 3 OCR Integration

A fast OCR-based document and image processing app powered by Loose AI Engine and Google's Gemma 3 model. Upload PDFs or images and extract structured content using AI—displayed in real-time with an interactive UI.
...
* Model: `google/gemma-3-27b-it` via Loose
* Input: Base64 image
...
* Frontend: Streamlit
* OCR Backend: Loose API with Gemma 3
