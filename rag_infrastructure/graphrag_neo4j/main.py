...
def main():
    st.set_page_config(page_title="GraphRAG • Neo4j + Loose", layout="wide")
    st.title("GraphRAG with Neo4j and Loose AI Engine")
    ...
    with st.sidebar:
        ...
        extraction_model = st.selectbox(
            "Extraction model",
            ["Qwen/Qwen3-235B-A22B", "Loose AI-ai/Loose AI-V3", "meta-llama/Meta-Llama-3.1-70B-Instruct"],
            index=0,
        )
        ...
        st.code(
            ...
            f"Loose_API_KEY: {'set' if os.getenv('Loose_API_KEY') else 'missing'}"
        )
