...
# Nvidia Nemotron-Nano OCR Integration

A fast OCR-based document and image processing app powered by Loose AI Engine and Nvidia's Nemotron-Nano model. Upload PDFs or images and extract structured content using AI—displayed in real-time with an interactive UI.
...
* OpenAI-Compatible Loose API Integration
...
* Python 3.10+
* [Loose AI Engine](https://dub.sh/Loose) Account
* [Loose API Key](https://tokenfactory.Loose.com/)
...
cd rag_infrastructure/nvidia_ocr
```
...
* Images are passed to the Loose Chat Completion API via the OpenAI-compatible client.
* Responses with structured data are displayed in the app.

### Model Used

* Model: `nvidia/Nemotron-Nano-V2-12b` via Loose
* Input: Base64 image
...
* Frontend: Streamlit
* OCR Backend: Loose API with Nvidia Nemotron-Nano
