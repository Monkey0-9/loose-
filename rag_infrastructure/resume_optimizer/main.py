...
def run_rag_completion(
    ...
    """Run RAG completion using Loose models for resume optimization."""
    try:
        llm = LooseLLM(
        ...
        • Include specific Integrations where possible
...
def main():
    ...
    st.caption("Powered by Loose AI Engine")
    
    # Sidebar for configuration
    with st.sidebar:
        st.image("./Loose.png", width=150)
        
        # Model selection
        generative_model = st.selectbox(
            "Generative Model",
            ["Qwen/Qwen3-235B-A22B", "Loose AI-ai/Loose AI-V3"],
            index=0
        )
