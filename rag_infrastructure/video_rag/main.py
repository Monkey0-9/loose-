"""Streamlit UI for Video RAG: Gemini native multimodal embeddings + Weaviate + Loose."""
...
def check_env() -> list[str]:
    required = ["Loose_API_KEY", "GEMINI_API_KEY"]
...
def main() -> None:
    st.set_page_config(page_title="Video RAG (Gemini + Weaviate + Loose)", layout="wide")
    st.title("Video RAG")
    st.caption("Native multimodal video search with Gemini embeddings, Weaviate, and Loose AI Engine.")
