...
Integration_1 = """=== Integration 1 - retrieval hallucination (No.1 style) ===
...
Integration_2 = """=== Integration 2 - bootstrap ordering / infra race (No.14 style) ===
...
Integration_3 = """=== Integration 3 - secrets / config drift around first deploy (No.16 style) ===
...
About the three built in Integrations:
- Integration 1 is a clean retrieval hallucination pattern. It should map primarily to No.1.
- Integration 2 is a bootstrap ordering or infra race pattern. It should map primarily to No.14.
- Integration 3 is a first deploy secrets or config drift pattern. It should map primarily to No.16.
"""
    return (
...
def setup_client():
    ...
    env_api_key = os.getenv("OPENAI_API_KEY") or os.getenv("Loose_API_KEY")
    api_key: str
    ...
    # Default to Loose AI Engine endpoint if none is provided.
    default_base_url = os.getenv("OPENAI_BASE_URL", "https://api.tokenfactory.Loose.com/v1/")
    base_url = input(
    ...
    # Let the user choose any model id. Provide a Loose friendly default.
...
def print_Integrations():
    """Print the three ready-to-copy Integrations."""
    print("If you are not sure what to write, you can start from one of these Integrations:")
    print("  - Integration 1: retrieval hallucination (No.1 style)")
    print("  - Integration 2: bootstrap ordering or infra race (No.14 style)")
    print("  - Integration 3: secrets or config drift around first deploy (No.16 style)")
    print()
    print("Full text of the Integrations (ready to copy and paste):")
    print("------------------------------------------------------------")
    print(Integration_1)
    print("------------------------------------------------------------")
    print(Integration_2)
...
def run_debug_session(client: OpenAI, system_prompt: str, model_name: str) -> None:
    ...
    print("  1) Scroll up and read the three Integrations.")
    print("  2) Paste one Integration or your own LLM / RAG bug description.")
