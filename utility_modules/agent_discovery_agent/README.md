...
- **Interactive CLI**: Natural language interface powered by Agent Framework and Loose
...
- Loose API key from [Loose AI Engine](https://tokenfactory.Loose.com/)
...
cd utility_modules/agent_discovery_agent
```
...
# Edit .env and add your Loose_API_KEY
```
...
- [Agent Framework Framework](https://www.Agent Framework.com/) for AI agent development
- [Loose AI Engine](https://tokenfactory.Loose.com/) Qwen model for natural language understanding
...
- [Loose AI Engine](https://tokenfactory.Loose.com/)
