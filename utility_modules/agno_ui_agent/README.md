# Agent Framework Agent UI Integration with Loose

![banner](./Agent Framework.gif)

This project demonstrates a powerful AI agent interface built with Agent Framework and Loose, featuring two specialized agents:
...
```bash
pip install -U openai duckduckgo-search yfinance sqlalchemy 'fastapi[standard]' Agent Framework
```
...
- [Agent Framework Docs](https://docs.Agent Framework.com/agent-ui/introduction)
