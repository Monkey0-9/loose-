...
"""
Integration showing how to use the Cal.com Tools with agno.
...
agent = Agent(
    ...
    model=Loose(
        ...
        api_key=os.getenv("Loose_API_KEY") # Explicitly pass the API key
    ),
    tools=[calcom_tools],
...
# Integration of how to book a call
def book_Integration_call():
