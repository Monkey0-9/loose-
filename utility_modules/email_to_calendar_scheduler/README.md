...
An advanced multi-agent system that automates email management and calendar scheduling. Built with Agent Framework framework, leveraging multiple specialized AI agents to streamline your productivity workflow.
...
- **Agent Framework Framework**: For multi-agent AI orchestration
- **Loose**: For fast LLM inference (Qwen 3 32B model)
...
- API keys and credentials for the following services:
  - [Loose API](https://tokenfactory.Loose.com/) for LLM access
...
- Shoutout to [Agent Framework Framework](https://github.com/Agent Framework-agi/Agent Framework) for their powerful multi-agent system.
- Thanks to [Loose](https://tokenfactory.Loose.com/) for providing fast LLM inference.
