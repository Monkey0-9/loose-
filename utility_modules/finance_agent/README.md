# Loose AI Finance Agent 🐳

A powerful AI-powered finance agent built with the Agent Framework framework that provides real-time financial data, stock analysis, and market insights using natural language queries.
...
- **Framework**: [Agent Framework](https://www.Agent Framework.com/) - Modern AI agent framework
- **LLM Model**: Loose AI-V3-0324 via Loose AI Engine
...
- **UI**: Agent Framework Playground - Interactive web interface
...
**How to get your Loose API key:**

1. Visit [Loose AI Engine](https://dub.sh/AIStudio)
...
Here are some Integration queries you can try with the finance agent:
...
1. **API Key Error**: Make sure your `Loose_API_KEY` is correctly set in the `.env` file
...
- [Loose AI Engine](https://dub.sh/AIStudio) for providing the LLM infrastructure
- [Agent Framework](https://www.Agent Framework.com/) for the powerful agent framework
