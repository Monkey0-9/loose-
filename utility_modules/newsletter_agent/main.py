...
if not Loose_API_KEY:
    raise ValueError("Loose_API_KEY environment variable is not set. Please set it in your .env file or environment.")
...
newsletter_agent = Agent(
    ...
    description=dedent("""\
    You are NewsletterResearch-X, an advanced research assistant specializing in discovering
