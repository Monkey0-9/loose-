...
Pipeline: WebRTC/Daily -> Cartesia STT -> Loose LLM (with tools) -> Cartesia TTS -> out.
...
from pipecat.services.Loose.llm import LooseLLMService
...
async def bot(runner_args: RunnerArguments):
    ...
    llm = LooseLLMService(
        ...
        settings=LooseLLMService.Settings(model="openai/gpt-oss-120b"),
    )
