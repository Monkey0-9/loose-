...
**Loose AI Engine** for LLM inference.
...
form POST  ->  FastAPI dispatch  ->  LiveKit room
                                        |
                 Deepgram STT -> Loose LLM -> Cartesia TTS
                                        |
...
- Python 3.10+
- Accounts / API keys: LiveKit, Loose AI Engine, Deepgram, Cartesia
...
cp .env.Integration .env     # fill in your keys
```
...
- **Loose AI Engine** — Llama 3.1 70B via `openai.LLM.with_Loose`
- **Deepgram Nova-3** — STT
- **Cartesia** — TTS
